...
-- Insert Droids
insert into characters (id, name, primary_function, dtype) values
    ('2000', 'C-3PO', 'Protocol', 'Droid'),
    ('2001', 'R2-D2', 'Astromech', 'Droid');

-- Insert Humans
insert into characters (id, name, home_planet, favorite_droid_id, dtype, gender_code_id) values
...
-- Luke Appears in
insert into characters_appears_in (characters_id, appears_in) values
    ('1000', 3),
    ('1000', 4),
    ('1000', 5),
    ('1000', 6);
